...
// watchable handful up to the verifiable max (MAX_ROUNDS_PER_TUNNEL ~ 100k co-signed updates, the
// most that fits under the backend's 32 MB /settle body cap) — the default flat-out arena target.
