...
export function deriveServerMove(optimalCells: number[], seedHex: string): number {
  if (optimalCells.length === 0) throw new Error("deriveServerMove: empty optimalCells");
